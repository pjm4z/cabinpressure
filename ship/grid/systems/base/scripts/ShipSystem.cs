...
public partial class ShipSystem : GridItem
{
	...
	[Export] public double taskTime = 1;
	protected HBoxContainer panel;
	protected Sprite2D sprite;
	[Export] public StateMachine brain;
	
	[Export] public float chargeCost;
...
//	[Export] protected int maxOrders;
	public bool executing = false;
	public virtual void fire() {
		active = true;
		//if (queuedOrders < maxOrders) {
		if (executing) {
			queuedOrders += 1;
		}
		GD.Print("FIRING " + Name + " " + queuedOrders + " " + active);
	}
